...
const FormLogin = () => {
  ...
  const onFinish = (values) => {
    ...
    } else if (username === 'qsnjalisco' && password === 'qsnjalisco2023') {
      const user = {
        username: 'qsnjalisco',
        roles: ['user'],
      };
...
useEffect(() => {
  ...
  if(storedUsername !== "analistas" ||storedUsername !== "qsnjalisco" && storedPassword !== "qsn123" || storedPassword !== "qsnjalisco2023"){
    setError("Usuario o contraseña incorrecta")
  } else {
